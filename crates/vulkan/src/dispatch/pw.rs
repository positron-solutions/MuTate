...
//! # Present Wait
//!
//! Presentation wait behavior encapsulation.  This can be used to measure course phase alignment of
//! the actual presentation.  The approach suffers from scheduler jitter even with zero timeouts.
//! More granular timing or ordering of draw dependencies needs some other kind of timing &
